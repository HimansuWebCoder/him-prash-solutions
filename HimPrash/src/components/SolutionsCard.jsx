    ...
    <div className="group max-w-sm mx-auto bg-white rounded-lg shadow-md overflow-hidden transform transition duration-500 hover:scale-105">
      ...
      <div className="p-6">
        ...
        <p className="text-gray-700 mb-4">
          We create stunning user interfaces using React.js to give your users
          the best experience.
        </p>
      ...
      <a
        href="#contact"
        className="block text-2xl bg-[#27E0B3] text-black font-semibold p-4 text-center cursor-pointer hover:bg-[#1FA887]"
      >
        Contact Us
      </a>
    </div>
  ...
  return (
    <div className="group max-w-sm mx-auto bg-white rounded-lg shadow-md overflow-hidden transform transition duration-500 hover:scale-105">
      ...
      <div className="p-6">
        ...
        <p className="text-gray-700 mb-4">
          With Node.js, we ensure your web applications are secure, fast, and
          scalable.
        </p>
        <div className="mt-4 hidden group-hover:block transition-opacity duration-300 ease-in-out">
          <h3 className="text-xl font-semibold text-gray-800 mb-2">
  ...
  return (
    <div className="group max-w-sm mx-auto bg-white rounded-lg shadow-md overflow-hidden transform transition duration-500 hover:scale-105">
      ...
      <div className="p-6">
        ...
        <p className="text-gray-700 mb-4">
          From UI/UX design to the backend, we deliver complete solutions for
          your business needs.
        </p>
        <div className="mt-4 hidden group-hover:block transition-opacity duration-300 ease-in-out">
          <h3 className="text-xl font-semibold text-gray-800 mb-2">
            Our Full-Stack Skills
          </h3>
          <ul className="list-disc list-inside text-gray-700">
...
const SolutionsCard = () => {
  return (
    <>
      <h1
        id="services"
        className="text-4xl text-white font-[400] py-8 px-12 text-left "
      >
