  ...
  return (
    <nav className="bg-[#0D1413] py-2 px-8 text-white sticky flex items-center justify-between top-0 z-10">
      ...
      <div className="flex gap-4">
        ...
        >
          <TfiLinkedin className="text-xl hover:text-[#1FA887]" />
        </a>
        <a
          ...
          className="mt-[1.5px]"
        >
          <FaXTwitter className="text-xl hover:text-[#1FA887]" />
        </a>
        <span
          className="menu-toggle cursor-pointer text-3xl md:hidden -mt-[7px]"
          onClick={toggleMenu}
        >
          &#9776;
        </span>
        ...
        >
          <span
            className={`close ${menuOpen ? "block" : "hidden"} cursor-pointer`}
            onClick={toggleMenu}
          >
            ✕
          </span>
          ...
          <div
            className={`social_links ${menuOpen ? "block" : "hidden"} flex justify-end items-center mr-5 gap-5`}
          >
            <a
              href="https://linkedin.com"
              target="_blank"
...
const Hero = () => (
  <section className="hero_section bg-[#0D1413] text-white text-center p-20">
    <h1 className="heading text-8xl leading-12 font-bold">
      Your Growth <span className="text-[#1FA887]">Our Mission</span>
      <br />
    </h1>
  </section>
);
  ...
  <section id="portfolio" className="text-center py-16 px-5">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
      ...
      <ProjectCard
        title="Project 3"
        imageUrl={Amazon}
        description="A social media app that connects users through shared interests."
      />
    </div>
  </section>
);
...
const Team = () => (
  <section id="team" className="text-white text-center py-16">
    ...
    <div className="flex flex-wrap justify-center gap-8 cursor-pointer">
      ...
      <a
        href="https://himansuwebportfolio.netlify.app/"
        target="_blank"
        rel="noopener noreferrer"
      >
        <TeamCard
...
const Contact = () => (
  <section id="contact" className=" py-14 sm:text-left m-auto">
    <p className="text-white">
      If you have any questions or would like to discuss your project, feel free
      to{" "}
      <a
        href="mailto:dev.prashant.kumaar@gmail.com"
        className="text-[#1FA887] font-bold"
      >
    ...
    <div className="discover w-full h-auto bg-[#1FA887] mt-40 flex flex-col sm:flex-row items-start justify-between">
      ...
      <div className="right w-full sm:w-1/2 flex flex-col sm:flex-row items-start justify-between px-10 sm:px-20 py-10 sm:py-20">
        <p className="mt-4 sm:mt-10 sm:ml-20 w-full sm:w-2/3 leading-7 sm:leading-[1.8] tracking-tight font-medium text-sm sm:text-[1rem] text-left">
          Find out how HimPrash's people-centered designs can make web solutions
          more empowering.
        </p>
        <a
          href="#services"
          className="circle w-14 h-14 sm:w-[8rem] sm:h-[8rem] border-black border-[1.5px] rounded-full flex items-center justify-center mt-6 sm:mt-0"
        >
      ...
      <div className="footer_content w-full sm:w-[94%] m-auto h-full flex flex-col gap-6 sm:gap-8 relative">
        <div className="footer_part1 h-auto sm:h-1/2 flex flex-col sm:flex-row items-start justify-between pt-20 pb-10 z-[1] px-5">
          <div className="left_part text-left mb-6 sm:mb-0 ">
            <a href="#">
              <h1 className="text-lg sm:text-[1.4rem] leading-6 sm:leading-[1.8] font-medium">
                Home
              </h1>
            </a>
            <a href="#services">
        ...
        <div className="footer_part2 py-5 h-auto sm:h-[20%] bg-black sticky top-[120%] z-[2] flex flex-col sm:flex-row items-center justify-between gap-4 sm:gap-0 border-t-[1.5px]  ">
          <div className="left_part flex flex-col sm:flex-row items-center gap-4 sm:gap-10">
            <span className="inline-block text-sm sm:text-[0.78rem] border-b-[1.5px]">
              Privacy Policy
            </span>
            <span className="inline-block text-sm sm:text-[0.78rem] border-b-[1.5px]">
              Terms of Use
          ...
          <div className="middle_part">
            <span className="inline-block text-sm sm:text-[0.78rem]">
              &copy;2024 HimPrash. All rights reserved.
            </span>
          </div>

          <div className="right_part flex gap-4 sm:gap-2">
            <a
              href="https://www.instagram.com/prashant"
              target="_blank"
              rel="noopener noreferrer"
            >
            ...
            <a
              href="https://www.linkedin.com/in/prashant-web-developer/"
              target="_blank"
              rel="noopener noreferrer"
            >
              <span className="inline-block text-lg sm:text-[1.4rem] hover:text-[#1FA887] cursor-pointer">
